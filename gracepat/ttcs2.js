...
let statuses =
  ["you haven't touched the bug yet", //0
    "you have touched the bug, good job", //1
    "you're getting good at it", //2
    "you have touched the bug enough, you can stop now", //3
    ...
    "if you keep doing it just to spite me then woo yeah touch the bug yeaaaa", //7
    "didn't work? damn", //8
    "im getting sleepy", //9
    "zzz", //10
    "DO YOU EVER STOP????", //11
    "DO YOU HAVE LIKE A LIFE???? OR ANYTHING??????", //12
    "you have won, this was a test, you are a real bug toucher, don't let anyone tell you what to do"]; //13
...
async function swag() {
  ...
  counterText.innerHTML = `YOU HAVE TOUCHED THE BUG ${counter} TIMES!!!`
